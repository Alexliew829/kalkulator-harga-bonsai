...
- GitHub Pages 需完整覆盖 V6.5 文件；Import V16.4 无需再次修改或重新部署。

V6.5 产品编号兼容：旧 PZxxxx 与 Import V16.4 新前缀编号可查询同一产品；匹配同时核对产品名称和原四位数字，最低售价仍使用当前产品资料。
...
部署：
- Calculator: GitHub Pages 覆盖全部 V6.5 文件。
...
V6.5 修正：MYR/TWD 大金额不重复货币符号；配合 Import V16.4 有效最低售价接口。
...
V6.5 product search speed optimization:
